public class Robot
{
    ...
    {
        return "Numero de serie:" + this.NumeroSerie + " - Potencia: " + this.PotenciaBase + " - Tipo de traccion: " + this.TipoTraccion.GetType().Name + " - Autonomia: " + this.TipoTraccion.Autonomia + " - Desgaste por uso: " + this.TipoTraccion.DesgastePorUso;
   ...
   private string nroSerie;
    ...
    {
        this.PotenciaBase -= this.TipoTraccion.DesgastePorUso;
    }
